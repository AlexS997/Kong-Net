...
{
    public partial class FrmOperazioniInCoda : Form
    {
        ...
        private void FrmOperazioniInCoda_Load(object sender, EventArgs e)
        {
        ...
        {
            string query = "SELECT * FROM Operazioni order by data";
        ...
        private void btnCancella_Click(object sender, EventArgs e)
        {
            ...
            string query = "DELETE FROM Operazioni WHERE id = " + id;
            connKong.ExecQuery(query);
        ...
        private void btnCambiaData_Click(object sender, EventArgs e)
        {
            ...
            string id = selectedRow["id"].ToString();
            string query = "UPDATE Operazioni SET data = '" + selectedRow["data"] + "' WHERE id = " + id;
